...
export const siteConfig: SiteConfig = {
	...
	siteURL: "https://minaiice.cn/", // 请替换为你的站点URL，以斜杠结尾
	...
	banner: {
		...
		src: {
			desktop: [
				"/assets/desktop-banner/66ccff.webp",
				"/assets/desktop-banner/66ccff0.webp",
				"/assets/desktop-banner/66ccff1.webp",
			], // 桌面横幅图片
			mobile: [
		...
		homeText: {
			...
			title: "Minai's Blog", // 主页横幅主标题

			subtitle: [
				"将想象变成现实， 这就是创造的内涵吧",
				"我从小就有个疑问，为何美好距离现实如此遥远？",
				"让我带你去吧，这座小镇，愿望实现的地方……",
				"一饮一啄，莫非前定"
			],
			typewriter: {
...
export const navBarConfig: NavBarConfig = {
	links: [
		...
		// 		{
		// 			name: "GitHub",
		// 			url: "https://github.com/minaiice",
		// 			external: true,
		// 			icon: "fa6-brands:github",
		// 		},
		// 		{
		// 			name: "Bilibili",
		// 			url: "https://space.bilibili.com/294643520",
		// 			external: true,
...
export const announcementConfig: AnnouncementConfig = {
	title: "简介", // 公告标题
	content: "你好，这里是一个简单的网站，用于个人学习与记录", // 公告内容
...
export const musicPlayerConfig: MusicPlayerConfig = {
	...
	meting_api:
		"https://meting.qjqq.cn/?server=:server&type=:type&id=:id&auth=:auth&r=:r", // Meting API 地址
	id: "2194879666", // 歌单ID
...
export const footerConfig: FooterConfig = {
	...
	customHtml: "<a href=\"https://icp.gov.moe/?keyword=20252047\" target=\"_blank\">萌ICP备20252047号</a>", // HTML格式的自定义页脚信息，例如备案号等，默认留空
